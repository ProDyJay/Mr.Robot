...
const token = "dddddddddddddddddddddddddddddddddd";
...
var mention = "<@378082646925770752>";
const opts = {
  maxResults: 3,
...
client.on('message', message => {
  ...
  message.reply('Whesh ma gueule ');
} else if (message.content === ("raconte moi une histoire")){
  message.reply('Trois homosexuels se baladent en pleine forêt. Le premier lâche un pet bruyant et leur dit: ....Désolé les gars ! ....Ils continuent leur marche quand le deuxième lâche une énorme explosion gazeuse, puis leur dit.... Vraiment désolé les gars ! .... Le troisième, légèrement en retrait, lâche un pet à peine audible. Les deux autres se retournent et disent en choeur : .... PUCEAU !!! ');
} else if (message.content === ("yo")){
  message.reply('Yo ? Tu tes cru chez ta mère !!! ');
} else if (message.content === ("pute")){
  message.reply('Je dis puuuuteux ');
